<template>
  <form
    class="bg-white w-full max-w-3xl mx-auto px-4 lg:px-6 py-8 shadow-sm rounded-md flex flex-col lg:flex-row"
  >
    ...
    <div class="w-full lg:w-1/2 lg:pl-8">
      <div class="w-full max-w-sm h-56" style="perspective: 1000px">
        <div
          ...
          :class="{'seeBack': !isCardFront}"
          style="transform-style: preserve-3d"
          @click="toggleBackCard"
        >
          <div
          ...
          >
            <nuxt-img
              loading="lazy"
              src="/payment/payment-card-bg.jpg"
            ...
            <div class="w-full px-8 absolute top-8">
              ...
              <div class="pt-6 flex justify-between">
                <div>
                  ...
                  <p  class="font-medium tracking-widest h-6">
