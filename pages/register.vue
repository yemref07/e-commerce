    ...
    >
      <div class="text-center text-base md:text-lg">
        ...
        <p>
          ...
          <nuxt-link to="/signin" class="text-torange"> Sign In </nuxt-link>
        </p>
      </div>
      ...
      <div class="flex flex-col gap-5">
        <div class="relative">
          <label class="input-label text-sm font-medium text-gray-700"
            >Your Name</label
          >
          <input
            v-model="nameSurname"
...
useHead({
  title: 'Register | Dummy E-Commerce',
  meta: [
    { name: 'description', content: 'Create a free account and start shopping' },
    { property: 'og:title', content: 'Register on Dummy E-Commerce' }, 
    ...
    { name: 'twitter:title', content: 'Register on Dummy E-Commerce' }, // Twitter title
  ],
})
