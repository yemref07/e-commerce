        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
          ...
          <tbody>
            <tr class="border-b text-tblack bg-gray-200">
              <th scope="row" class="px-6 py-4 font-semibold">Screen Size</th>
              <td class="px-12 py-4">
                The Galaxy S24 series features a "Dynamic LTPO AMOLED 2X"
                display with HDR10+ support, 2600 nits of peak brightness, and
                "dynamic tone mapping" technology. All models use an ultrasonic
                in-screen fingerprint sensor. The S24 series uses a variable
                refresh rate display with a range of 1 Hz or 24 Hz to 120 Hz.
              </td>
            </tr>
          </tbody>
        </table>
